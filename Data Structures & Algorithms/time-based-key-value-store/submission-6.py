class TimeMap:
    ...
    # a specific key
    # chance that we dont find a good val
    # and thus need rightmost value to return
    # assuming r did not underflow to -1
    # in which case we did not find res and return ""
